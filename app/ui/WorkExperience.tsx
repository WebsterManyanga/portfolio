...
const WorkExperience = () => {
  ...
  const jobs = careers.map((job) => (
    <div className="lg:mt-20 before:content-[''] before:block before:w-1 before:h-40 lg:before:h-24 before:bg-white relative before:absolute before:-left-6 before:top-10">
  ...
  return (
    <section className="h-full lg:pt-10 lg:mt-20 snap-start" id="workExperience">
      ...
      <div className="h-full overflow-clip  lg:mt-0 lg:pt-0   mt-5 px-10 pt-20 lg:flex  flex-col  lg:pl-96 lg:pb-10 ">
        {jobs}
      </div>
